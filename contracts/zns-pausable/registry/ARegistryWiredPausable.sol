...
/**
 * @title ARegistryWiredPausable.sol - Abstract contract, intdroducing ZNSRegistry to the storage
...
*/
abstract contract ARegistryWiredPausable {
     ...
     */
    IZNSRegistryPausable public registry;
    ...
    function _setRegistry(address registry_) internal {
        ...
        registry = IZNSRegistryPausable(registry_);
