...
contract ZNSAddressResolverPausable is
    ...
    modifier whenNotPaused() {
        require(!paused(), "ZNSAddressResolver: Contract is paused");
        _;
    }

    modifier whenPaused() {
        require(paused(), "ZNSAddressResolver: Contract is not paused");
        _;
    }
    ...
    function getInterfaceId() public pure override returns (bytes4) {
        return type(IZNSAddressResolverPausable).interfaceId;
    }
