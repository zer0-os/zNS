...
contract ZNSRootRegistrarPausable is
    ...
    modifier whenNotPaused() {
        require(!paused(), "ZNSRootRegistrar: Contract is paused");
        _;
    }

    modifier whenPaused() {
        require(paused(), "ZNSRootRegistrar: Contract is not paused");
        _;
    }
    ...
    */
    function setSubRegistrar(address subRegistrar_) external override onlyAdmin {
        ...
        subRegistrar = IZNSSubRegistrarPausable(subRegistrar_);
