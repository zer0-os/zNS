...
contract ZNSPriceOracleMock is AccessControlled, UUPSUpgradeable, IZNSPriceOracleMock {
    ...
    external
    override(AccessControlled, IZNSPriceOracleMock)
    onlyAdmin
    {
        _setAccessController(accessController);
    }

    function getAccessController() external view override(AccessControlled, IZNSPriceOracleMock) returns (address) {
