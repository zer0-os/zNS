...
import { IZNSRegistryMock } from "./IZNSRegistryMock.sol";
import { AccessControlled } from "../../access/AccessControlled.sol";
import { UUPSUpgradeable } from "@openzeppelin/contracts-upgradeable/proxy/utils/UUPSUpgradeable.sol";


contract ZNSRegistryMock is AccessControlled, UUPSUpgradeable, IZNSRegistryMock {
    /**
    ...
    function setNewMapping(uint256 newNumber_) public override {
        newMapping[newNumber_] = msg.sender;
    }

    function setNewMappingSpecific(uint256 newNumber_, address newAddress_) public override {
        newMapping[newNumber_] = newAddress_;
    }

    function setNewNumber(uint256 newNumber_) public override {
        newNumber = newNumber_;
    }

    function setNewAddress(address newAddress_) public override {
