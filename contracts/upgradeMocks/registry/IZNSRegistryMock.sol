...
interface IZNSRegistryMock {
    ...
    function setNewMapping(uint256 newNumber_) external;

    function setNewMappingSpecific(uint256 newNumber_, address newAddress_) external;

    function setNewNumber(uint256 newNumber_) external;

    function setNewAddress(address newAddress_) external;
