...
abstract contract AccessControlled {
    ...
    /**
     * @dev Emitted when the access controller contract address is set.
    */
    event AccessControllerSet(address accessController);

    /**
     * @dev Address of the ZNSAccessController contract.
    */
    ...
    */
    ...
    /**
     * @dev Virtual function to make sure the getter is always implemented in children,
    ...
    /**
     * @dev Virtual function to make sure the setter is always implemented in children,
    ...
    /**
     * @dev Internal function to set the access controller address.
