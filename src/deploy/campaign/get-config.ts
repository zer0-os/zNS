...
import { ZSepolia, ZTokenMainnet } from "../missions/contracts/zns-base/z-token/mainnet-data";
...
export const validateEnv = (
  ...
  if (envLevel === "prod") {
    ...
    requires(process.env.STAKING_TOKEN_ADDRESS === ZTokenMainnet.address, STAKING_TOKEN_ERR);
  }
