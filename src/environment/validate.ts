...
const required = [
  ...
  "LOG_LEVEL", "ENV_LEVEL", "MAX_PRICE", "MIN_PRICE", "MAX_LENGTH", "BASE_LENGTH", "PROTOCOL_FEE_PERC",
  "DECIMALS", "PRECISION", "DOMAIN_TOKEN_NAME", "DOMAIN_TOKEN_SYMBOL", "ROYALTY_FRACTION", "MOCK_MEOW_TOKEN",
  "SRC_CHAIN_NAME", "MOCK_ZKEVM_BRIDGE", "DEST_NETWORK_ID", "DEST_CHAIN_NAME", "DEST_CHAIN_ID",
];
