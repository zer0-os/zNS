...
export const runAllFlows = async () => {
  ...
  await zns.zToken.connect(governor).approve(await zns.treasury.getAddress(), ethers.MaxUint256);
  ...
  await zns.zToken.transfer(user.address, ethers.parseEther("10000"));
